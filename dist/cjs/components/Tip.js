...
const classnames_1 = require("../lib/classnames");
...
class Tip extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.classNames)("Tip", className) }, compact ? (react_1.default.createElement("div", { className: "Tip__compact", onClick: () => {
                onOpen();
